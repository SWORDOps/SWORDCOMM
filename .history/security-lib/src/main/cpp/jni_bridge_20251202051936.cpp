...
Java_im_molly_security_CacheOperations_nativeFillCacheWithNoise(JNIEnv* env, jclass /* clazz */,
    jint sizeKb, jint screenX, jint screenY, jboolean enableGallopDash) {
    CacheOperations::fill_cache_with_noise(sizeKb, screenX, screenY, enableGallopDash == JNI_TRUE);
}
...
Java_im_molly_security_MemoryScrambler_nativeCreateDecoyPatterns(JNIEnv* env, jclass /* clazz */,
    jint sizeMb, jint screenX, jint screenY, jboolean enableGallopDash) {
    MemoryScrambler::create_decoy_patterns(sizeMb, screenX, screenY, enableGallopDash == JNI_TRUE);
}
